    ...
    <div className={`relative md:w-[80%] w-full md:pb-[10rem] mt-2 ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`flex flex-col gap-4 md:grid md:grid-cols-3 w-full p-4 border border-neutral-700 transition-colors duration-200 ${
                selectedIndex === index ? 'bg-[#AAAAAA]' : ''
              } ${itemClassName}`}
            >
              <p
              ...
              <p className={`w-full text-center text-sm font-semibold lowercase mb-1 ${
              ...
              <a
                ...
                className={`w-full md:text-right text-sm font-semibold lowercase mb-1 truncate ${
                  selectedIndex === index ? 'text-black' : 'text-[#aaaa]'
                }`}
              >
                {item.url}
